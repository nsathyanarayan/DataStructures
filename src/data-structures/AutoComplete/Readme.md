...
AutoComplete project is based on the Trie design pattern. AutoComplete will return all the matching words based on given input. 
For example : if you submit a keyword "Te". it will list all the matching words like "Ten", "Ted", "Tea" etc.
